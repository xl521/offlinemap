                ...
                for (; mZ < mZoomArray.Count; )
                {
                    ...
                    for (; mX <= mRightTopTile.x; mX++)
                    {
                        ...
                        for (; mY <= mRightTopTile.y; )
                        {
                            ...
                            if (mMapType == 0)
                            {
                            //http://api0.map.bdimg.com/customimage/tile?&x=4&y=2&z=5&udt=20180829&scale=1&ak=&customid=midnight
                                //街道图（png） http://online0.map.bdimg.com/tile/?qt=tile&x=6536&y=1797&z=15&styles=pl
                              //  task.url = host + "?qt=tile&x=" + mX + "&y=" + mY + "&z=" + mZoomArray[mZ] + "&styles=pl&customid=midnight";
                                task.url = host + "?&x=" + mX + "&y=" + mY + "&z=" + mZoomArray[mZ] + "&udt=20180829&scale=1&ak=&customid=midnight";
